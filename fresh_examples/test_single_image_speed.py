"""
Test Single Image Speed - Performance Measurement
Warm-up + Multiple runs for accurate FPS measurement
"""
...
def test_speed():
    print("🚀 Testing Single Image Speed Performance")
    print("=" * 50)
    ...
    print(f"🔄 Running {num_runs} iterations for accurate timing...")
    ...
    print(f"   Persons:   {len(boxes) if 'boxes' in locals() else 0} detected")
